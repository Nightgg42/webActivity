...
router.get('/Dataassessment/:activityname/:actYear', async function(req, res, next) {
    const activityName = req.params.activityname; 
...
router.get('/DataassessmentByID/:activityname/:studentid/:actYear', async function(req, res, next) {
    const activityName = req.params.activityname;
